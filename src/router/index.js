...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "CompanyItem" */ "./views/company/CompanyItem.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "ContactList" */ "./views/contact/ContactList.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "ContactItem" */ "./views/contact/ContactItem.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "DepartmentList" */ "./views/department/DepartmentList.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "DepartmentItem" */ "./views/department/DepartmentItem.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "EducationList" */ "./views/education/EducationList.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "EducationItem" */ "./views/education/EducationItem.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "PracticeList" */ "./views/practice/PracticeList.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "PracticeItem" */ "./views/practice/PracticeItem.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "SirenTypeList" */ "./views/sirentype/SirenTypeList.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "SirenTypeItem" */ "./views/sirentype/SirenTypeItem.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "CertificateList" */ "./views/certificate/CertificateList.vue"
      ),
    meta: {
      requiresAuth: true,
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "CertificateItem" */ "./views/certificate/CertificateItem.vue"
      ),
    meta: {
      requiresAuth: true,
